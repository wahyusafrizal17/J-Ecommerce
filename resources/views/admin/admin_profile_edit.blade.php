                     ...
                     <div class="row">
                       <div class="col-12">	
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <img id="showImage" class="rounded-circle" src="{{ (!empty($adminData->profile_photo_path))? 
                                     url('upload/admin_images/'.$adminData->profile_photo_path):url('upload/no_image.jpg') }}" alt="User Avatar" style="width: 100px; height: 100px;">
                                </div>
